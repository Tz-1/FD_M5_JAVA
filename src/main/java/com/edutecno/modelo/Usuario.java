...
public class Usuario {
	...
	//Constructor vacio para multiple usos
	public Usuario() {
	...
	//Metodo para conseguir de manera instanea el signo zodiacal del usuario, utilizando el DAO de Horoscopo
	...
	//Para testeo de obtencion del signo zodiacal mediante consola
	@Override
