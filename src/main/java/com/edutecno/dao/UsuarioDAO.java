...
public class UsuarioDAO {
	...
	//DAO para añadir el usuario que se registrara a la base de datos de Usuarios. Uso el System.Out.Print para seguir la logica por la consola del programa.
	...
	//DAO de listados para su funcion en la busqueda de estos. Evito traer datos sensibles (Excepto Fecha)
	...
	//Funcion para conseguir en general
	...
	//Username y correo son unicos en la base de datos. DAO creados para obtener los usuarios y lanzar errores eficientes para en el front-end
